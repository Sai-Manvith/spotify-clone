...
const Player = () => {
    ...
    const {track,seekBg,seekBar, playStatus, play,pause,time,previousSong,nextSong,seekSong} = useContext(PlayerContext);
  return (
    <div className='h-[10%] bg-black flex justify-between text-white items-center p-4'>
